...
function SIgnUpPageForm() {
    ...
    const onSubmit = async (data)=>{
      ...
      console.log (data)
      const res = await axios.post(`${config.backend_uri}/sign-up`,{
        email : data.email,
        ...
        <div className='from flex justify-center items-center'>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <Input label={"Username"} labelVis={true} placeholder="Enter a username." name="username" {...register("username",{required:true,max:12})}/>
